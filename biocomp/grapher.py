...
def convert_key_to_name(key):
    mapping = {
        "train_fitness_best": "Train Fitness Best",
        "train_fitness_mean": "Train Fitness Mean",
        "test_fitness_best": "Test Fitness Best",
        "test_fitness_mean": "Test Fitness Mean",
    }

    if key in mapping:
        return mapping[key]

    return key[0].upper() + key.replace("_", " ")[1:]


def plot_fitness_area(generation_count, logs, key, line_args=None, fill_args=None, name=None, fill=True):
...
def main():
    experiments = {
        ...
        'data3': load_logfiles([
            # "c/logs/data3/2019-11-28.16:27:50.log",
            # "c/logs/data3/2019-11-28.16:33:48.log",
            # "c/logs/data3/2019-11-28.16:39:25.log",
            # "c/logs/data3/2019-11-28.16:45:24.log",
            # "c/logs/data3/2019-11-28.16:49:18.log",
            # "c/logs/data3/2019-11-28.16:54:29.log",
            # "c/logs/data3/2019-11-28.16:57:43.log",
            # "c/logs/data3/2019-11-28.17:02:11.log",
            # "c/logs/data3/2019-11-28.17:07:21.log",
            # "c/logs/data3/2019-11-28.17:12:45.log",

            # learning with initial rule count of 60
            "c/logs/data4/2019-11-19.21:31:14.log",
            "c/logs/data3/2019-11-28.17:57:33.log",
            "c/logs/data3/2019-11-19.20:45:13.log",
            "c/logs/data3/2019-11-28.19:07:29.log",
            "c/logs/data3/2019-11-28.18:32:43.log",
            "c/logs/data3/2019-11-28.20:58:09.log",
            "c/logs/data3/2019-11-28.19:45:37.log",
            "c/logs/data3/2019-11-28.19:22:28.log",
            "c/logs/data3/2019-11-28.18:49:16.log",
            "c/logs/data3/2019-11-28.18:16:31.log",
            "c/logs/data3/2019-11-28.20:12:20.log",
            "c/logs/data3/2019-11-28.20:38:12.log",

        ]),

        'data3_no_selection_switch': load_logfiles([
            "c/logs/data3/2019-11-29.01:29:18.log",
            "c/logs/data3/2019-11-29.01:47:15.log",
            "c/logs/data3/2019-11-29.02:22:28.log",
            "c/logs/data3/2019-11-29.02:38:33.log",
            "c/logs/data3/2019-11-29.08:07:32.log",
            "c/logs/data3/2019-11-29.09:10:34.log",
            "c/logs/data3/2019-11-29.09:45:54.log",
            "c/logs/data3/2019-11-29.10:00:00.log",
            "c/logs/data3/2019-11-29.10:49:06.log",
            "c/logs/data3/2019-11-29.11:10:41.log",
        ]),

        # # learning with initial rule count of 5
        # 'data3_rule_count_5': load_logfiles([
        #     "c/logs/data3/2019-11-28.20:58:09.log",
        #     "c/logs/data3/2019-11-28.22:52:50.log",
        #     "c/logs/data3/2019-11-28.23:06:17.log",
        #     "c/logs/data3/2019-11-28.23:20:45.log",
        #     "c/logs/data3/2019-11-28.23:34:18.log",
        #     "c/logs/data3/2019-11-28.23:50:14.log",
        #     "c/logs/data3/2019-11-29.00:03:35.log",
        #     "c/logs/data3/2019-11-29.00:18:55.log",
        #     "c/logs/data3/2019-11-29.00:33:09.log",
        #     "c/logs/data3/2019-11-29.00:47:09.log",
        #     "c/logs/data3/2019-11-29.01:01:22.log",
        # ]),

        # 'data4': load_logfiles([
        #     "c/logs/data4/2019-11-28.21:38:54.log",
        #     "c/logs/data4/2019-11-28.20:15:33.log",
        #     "c/logs/data4/2019-11-19.21:31:14.log",
        #     "c/logs/data4/2019-11-28.21:56:24.log",
        # ]),
    }
    ...
    for name, description in {
        'data3': 'data3 - lcs (selection switch threshold 0.1)',
        'data3_no_selection_switch': 'data3 - lcs comparison between selection switching',
    }.items():
        for key in [
            'train_fitness_best',
            'train_fitness_mean',
            ...
            keyname = 'Disabled - ' if 'no_selection' in name else 'Enabled - '
            keyname += convert_key_to_name(key)
            plot_fitness_area(25000, experiments[name], key, name=keyname,
                              # line_args={
                              #     'color': color,
                              #     'linestyle': 'dashed' if 'no_selection' in name else '-',
                              # },
                              fill=False)
        plt.xlabel("generations")
        plt.ylabel("fitness")
        plt.legend(loc="lower right")
        plt.title('data3 - impact of selection switch')
        plt.savefig(f'graphs/{name}.png')
    plt.show()

    # for name, description in {
    #     'data4': 'data4 - lcs (mutation 0.003, crossover 0.85)',
    # }.items():
    #     for key in ['train_fitness_best', 'train_fitness_mean']:
    #         plot_fitness_area(25000, experiments[name], key)
    #     plt.xlabel("generations")
    #     plt.ylabel("fitness")
    #     plt.legend(loc="lower left")
    #     plt.title(description)
